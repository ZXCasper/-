export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx2aa17f8f3d0d70ce',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '97c3dab9892a85c661b2edb1d19a30d7',
  ...
  USERS: [oWurd6pDW0rNyidPpp-c2lG3ZuA0
    {
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '小宝宝', year: '2000', date: '11-04',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '小哲哲', year: '2000', date: '11-29',
        },
        {
          type: '节日', name: '恋爱纪念日', year: '2017', date: '01-01',
        }
      ],
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {
      type: '*生日', name: '小宝宝', year: '2000', date: '11-04', isShowAge: true,
    },
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
    {
      type: '生日', name: '小宝宝', year: '2000', date: '11-29', isShowAge: true,
    },
    {
      type: '节日', name: '爱你纪念日', year: '2017', date: '01-01',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
